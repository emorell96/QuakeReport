...
public partial class NewCollectionPoint
{
    private MudForm? _form;
    private readonly CollectionPointForm _model = new();
    private readonly CollectionPointFormValidator _validator = new();
    ...
    private async Task SubmitAsync()
    {
        ...
        try
        {
            var response = await ApiClient.CreateCollectionPointAsync(_model.ToApiDto());
